...
export async function streamText(
  ...
  // Inject active plugin context (e.g. current chess board state)
  const pluginContext = pluginController.getActivePluginContext()
  if (pluginContext) {
    toolSetInstructions += pluginContext
  }
  ...
  try {
    ...
    let tools: ToolSet = {
      ...
      ...pluginController.getAvailableTools(),
    }
    if (webBrowsing) {
